...
工具是繞著大學性平承辦人的日常業務做的。它能處理文書與文件管理，處理不了妖魔鬼怪、喬不攏的開會時間，也處理不了那種隨時丟一堆智缺法盲指示、還愛在人事上指手畫腳的○○法定。
...
![通報追蹤建立畫面](介紹/完成/通報功能/通報建立01.jpg)
...
![建立案件：基本資料](介紹/案件工作臺/建立案件1.jpg)

![建立案件：關鍵日期](介紹/案件工作臺/建立案件2.jpg)

![建立案件：當事人與特殊教育檢核](介紹/案件工作臺/建立案件3.jpg)
...
![回報程序節點：結果、日期與內容](介紹/案件工作臺/回報節點1.jpg)

![回報程序節點：附件與外部索引](介紹/案件工作臺/回報節點2.jpg)

![回報程序節點：流程檢核與人工確認](介紹/案件工作臺/回報節點3.jpg)
...
![調查路徑與簡化調查程序](介紹/案件工作臺/案件工作臺11.jpg)

![訪談時程安排](介紹/案件工作臺/案件工作臺12.jpg)
...
![更換承辦人與歷程紀錄](介紹/案件工作臺/案件工作臺-案件總覽-更換承辦人.jpg)
...
![本校名稱與 Logo 設定](介紹/完成/學校logo設定/logo設定2.jpg)
...
下載後請先確認檔案雜湊，再依校內軟體安裝與執行規範使用。執行檔可直接在 Windows 上運作，不需要連線。

## 完整說明手冊與專案沿革

- [完整操作手冊](docs/完整操作手冊.md)：安裝、工作區、授權、案件流程、日常業務、備份與常見操作。
- [版本沿革](docs/版本沿革.md)：功能變更、流程修正、授權調整與歷次版本紀錄。
- [完整 EULA](LICENSES/EULA-完整版.txt)：授權條款與使用限制。
